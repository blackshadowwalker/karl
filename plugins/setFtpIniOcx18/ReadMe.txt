========================================================================
		ActiveX Control DLL : SETINIOCX
========================================================================

ControlWizard has created this project for your SETINIOCX ActiveX Control
...
that make up your SETINIOCX ActiveX Control DLL.
...
SetIniOcxCtl.h
	This file contains the declaration of the CSetIniOcxCtrl C++ class.

SetIniOcxCtl.cpp
	This file contains the implementation of the CSetIniOcxCtrl C++ class.

SetIniOcxPpg.h
	This file contains the declaration of the CSetIniOcxPropPage C++ class.

SetIniOcxPpg.cpp
	This file contains the implementation of the CSetIniOcxPropPage C++ class.

SetIniOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSetIniOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file setIniOcx.rc.
